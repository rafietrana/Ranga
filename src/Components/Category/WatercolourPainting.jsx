...
const WatercolourPainting = () => {
  ...
  const subCategory = "Watercolour Painting";
        ...
        <div className="bg-[#ffffff] rounded-md p-10 my-[100px] max-w-[9000px] shadow">
          ...
          <div className="mt-10 grid grid-cols-4 gap-5">
            {filteredArtAndCraft.map((item) => (
              <div key={item.id} className="card bg-[#E5E2DB] card-compact w-96 shadow-xl rounded-none">
                <figure>
                  <img
                ...
                <div className="p-5 text-left">
                  ...
                  <p className="text-[16px]">{item.stockStatus}</p>
